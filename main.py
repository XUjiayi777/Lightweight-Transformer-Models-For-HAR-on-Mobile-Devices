...
architectureType = str(architecture)+'_'+'3sensors'+'_'+str(int(localEpoch))+'localEpoch_'+str(int(frameLength))+'frameLength_'+str(timeStep)+'TimeStep_'+str(projection_dim)+"ProjectionSize_"+str(learningRate)+'LR'
